...
import OGImage from './assets/projects/og.png';

export default function App() {
  return (
    <>
     <Helmet>
      <title>John Sarmiento</title>
      <meta name="title" content="JS Portfolio" />
      <meta name="description" content="Web developer with 3 years of experience bringing design templates to life using React, HTML/CSS, and JavaScript. Explore my personal projects and experiments." />
      <meta name="author" content="John Sarmiento" />
